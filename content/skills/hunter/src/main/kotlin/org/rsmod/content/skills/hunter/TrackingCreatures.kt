...
/**
 * A single tracking creature - not a [HunterCreature], and unlike every other family it has no
 * success pair at all: the catch is deterministic (docs/hunter.md). [xp] is stored x10; [fur] is
 * the biome-named cache symbol, which diverges from the wiki creature name.
 */
