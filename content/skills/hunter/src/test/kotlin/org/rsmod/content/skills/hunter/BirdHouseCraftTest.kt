...
/**
 * Making a bird house - the technique's entry point. Every expectation is pinned to a literal
 * read off the wiki ([WIKI], cross-checked against a second independent page per tier), never to
 * the column it is testing. Serialised for the reason the rest of the suite is.
 */
