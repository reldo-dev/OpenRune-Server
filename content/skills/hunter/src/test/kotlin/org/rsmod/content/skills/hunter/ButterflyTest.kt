...
/**
 * Butterfly netting, driven in-process - the cases a live client cannot force. The two that matter
 * most, [jarlessCatchStillAwardsXpButNoJar] and [aFullInventoryStillJarsTheCatch], assert things
 * whose absence looks identical in game to their presence.
 */
