...
/**
 * A world for tracking, emptier still than [HunterCrabTrapTestWorld]: a player, an inventory, a
 * worn container and a scripted RNG. The two locs it takes are built by hand over their packed
 * types, exactly as [HunterCrabTrapTestWorld]
