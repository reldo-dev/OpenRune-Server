...
/**
 * Following a trail: inspect, advance, catch - on the synthetic diamond, whose segments carry
 * *real* trail varbits so every write resolves through the server's own path. Assertions read
 * varbits, never a varp (varp 925 carries another system's fields). Serialised as the rest of the
 * suite is.
 */
