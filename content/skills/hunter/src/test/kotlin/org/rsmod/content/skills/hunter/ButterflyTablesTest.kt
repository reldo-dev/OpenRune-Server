...
class ButterflyTablesTest {
    ...
    /**
     * The load-bearing observation behind the three guessed rows: the two published members are
     * pointwise identical everywhere they overlap - one shared curve, not two anchored ones. It
     * does *not* establish level-alone catch chance; the moonlight moth disagrees
